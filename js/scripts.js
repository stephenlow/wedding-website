$(document).ready(function () {
    ...
    for (var i = 0; i < share_bar.length; i++) {
        var html = '<iframe allowtransparency="true" frameborder="0" scrolling="no"' +
            'src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + '&amp;text=' + encodeURIComponent(document.title) + '&amp;via=stephelow&amp;hashtags=marriagebaos,AuLowCanYouGo&amp;count=horizontal"' +
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b2b87420534c3057f6d5259482313a8d'
            && MD5($('#invite_code').val()) !== '2ac7f43695eb0479d5846bb38eec59cc') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycby950PykoVmw-kRnyND-Pov7rt0c8yFRsl-DC6iULDK2V6lral_TCukJzMt-YSzNFCD2w/exec', data)
                .done(function (data) {
                    console.log(data);
